 ...
 */
namespace Hanslife\Hykafka\Listener;

use Doctrine\Instantiator\Instantiator;
use Hanslife\Hykafka\Annotation\Producer;
...
class MainWorkerStartListener implements ListenerInterface
{
    ...
    public function process(object $event): void
    {
        ...
        if ($producerMessages) {
            $producer = $this->container->get(\Hanslife\Hykafka\Producer::class);
    ...
    protected function isEnable(): bool
    {
        ...
        return (bool) $config->get('amqp2.enable', true);
    }
}
